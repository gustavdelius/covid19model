...
dates = list()
reported_cases = list()
stan_data = list(M=length(countries),Pop=NULL,N=NULL,p=p,x1=poly(1:N2,2)[,1],x2=poly(1:N2,2)[,2],
                 y=NULL,covariate1=NULL,covariate2=NULL,covariate3=NULL,covariate4=NULL,
                 covariate5=NULL,covariate6=NULL,covariate7=NULL,deaths=NULL,
...
for(Country in countries) {
  ...
  Pop <- ifr.by.country$population[ifr.by.country$country == Country] * 1000
  ...
  stan_data$Pop = c(stan_data$Pop, Pop)
...
F = rep(0, N2) # distribution function of time to death
