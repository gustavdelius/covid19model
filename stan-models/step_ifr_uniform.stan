...
parameters {
  ...
  real<lower = 0.05, upper = 20> infecteds_multiplier; // We will _divide_ ifr by infecteds_multiplier
...
transformed parameters {
  ...
  vector<lower = 0>[M] ifr_factor = ifr_noise / infecteds_multiplier; 
  ...
  real<lower = 0> tau = tau_unit / 0.03 * infecteds_multiplier; 
